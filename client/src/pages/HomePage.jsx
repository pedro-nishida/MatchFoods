...
const NoMoreProfiles = () => (
	<div className='flex flex-col items-center justify-center h-full text-center p-8'>
		<Frown className='text-[#e6a3a3] mb-6' size={80} />
		<h2 className='text-3xl font-bold text-gray-800 mb-4'>Calma lá speedruner!</h2>
		<p className='text-xl text-gray-600 mb-6'>Mano mais nada?&apos;Talvez deva comer em casa mesmo</p>
	</div>
);
